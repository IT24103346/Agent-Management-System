    ...
    <div class="pt-20 pb-8 px-8">
      ...
      <div class="border-b border-gray-200 mb-8">
        <div class="flex justify-center space-x-8">
          ...
          <button class="text-gray-500 pb-4 px-2 font-medium hover:text-gray-700">My Clients</button>
          <button class="text-gray-500 pb-4 px-2 font-medium hover:text-gray-700">Requests</button>
          <button class="text-gray-500 pb-4 px-2 font-medium hover:text-gray-700">Recent Activities</button>
        </div>
      </div>
