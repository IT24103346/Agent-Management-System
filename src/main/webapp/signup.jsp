...
<head>
    ...
    <style>
        ...
        .gradient-overlay {
            background: linear-gradient(45deg, rgba(5, 150, 105, 0.9), rgba(16, 185, 129, 0.9));
        }
        .btn-primary {
...
<div class="min-h-screen flex">
    ...
    <div class="hidden lg:flex lg:w-1/2 relative">
        <img src="https://images.unsplash.com/photo-1560518883-ce09059eeffa?ixlib=rb-1.2.1&auto=format&fit=crop&w=1950&q=80"
             class="w-full h-full object-cover" alt="Real Estate">
        <div class="absolute inset-0 gradient-overlay"></div>
        <div class="absolute inset-0 flex flex-col justify-center px-12 text-white">
            <h1 class="text-4xl font-bold mb-4">Join Trusty Agents</h1>
            <p class="text-lg mb-8">Create your account and find the perfect real estate agent for your needs.</p>
            <div class="space-y-4">
                <div class="flex items-center">
                    <svg class="w-6 h-6 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
                    </svg>
                    <span>Find trusted local agents</span>
                </div>
                <div class="flex items-center">
                    <svg class="w-6 h-6 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
    ...
    <div class="w-full lg:w-1/2 flex items-center justify-center px-4 sm:px-6 lg:px-8">
        <div class="max-w-md w-full space-y-8">
            <div class="text-center">
                <img src="https://via.placeholder.com/150x50?text=Trusty+Agents" alt="Trusty Agents Logo" class="mx-auto h-12 w-auto">
                <h2 class="mt-6 text-3xl font-extrabold text-gray-900">
                    Create your account
                </h2>
                <p class="mt-2 text-sm text-gray-600">
                    Join our network of home buyers, sellers, and agents
                </p>
            </div>
            ...
            <form class="mt-8 space-y-6" action="register" method="POST">
                    ...
                    <div>
                        ...
                        <div class="mt-1 flex rounded-md shadow-sm">
                            <div class="flex items-center mr-4">
                                <input id="client" name="accountType" type="radio" value="client" checked
                                       class="h-4 w-4 text-emerald-600 focus:ring-emerald-500 border-gray-300">
                                <label for="client" class="ml-2 block text-sm text-gray-700">
                                    I'm a Client
                                </label>
                            </div>
                            <div class="flex items-center">
                                <input id="agent" name="accountType" type="radio" value="agent"
                                       class="h-4 w-4 text-emerald-600 focus:ring-emerald-500 border-gray-300">
                                <label for="agent" class="ml-2 block text-sm text-gray-700">
                                    I'm an Agent
                                </label>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="mt-1">
                                <input id="firstName" name="firstName" type="text" required
                                       class="appearance-none block w-full px-4 py-3 border border-gray-300 rounded-lg placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition duration-150 ease-in-out"
                ...
                <div>
                    <button type="submit"
                            class="group relative w-full flex justify-center py-3 px-4 border border-transparent text-sm font-medium rounded-lg text-white btn-primary hover:bg-emerald-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-emerald-500 transition duration-150 ease-in-out transform hover:scale-105">
                        Create Account
                    </button>
                </div>
            </form>
            ...
            <div class="text-center">
                <p class="text-sm text-gray-600">
                    ...
                    <a href="login.jsp" class="font-medium text-emerald-600 hover:text-emerald-500">
                        Sign in
                    </a>
                </p>
            </div>
